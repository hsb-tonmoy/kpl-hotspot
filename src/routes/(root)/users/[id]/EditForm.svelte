<script>
	import { FloatingLabelInput, Helper, Toggle } from 'flowbite-svelte';
	...
	import TemporaryPassword from './tempPassword/TemporaryPassword.svelte';
...
<form class="px-4 py-6 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" use:form>
	<section class="grid grid-cols-1 md:grid-cols-2 gap-6">
		...
		<div class="">
			<TemporaryPassword name={user.name} id={user.id} />
		</div>
	</section>
